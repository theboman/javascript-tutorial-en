...
The notable thing is that both variants: with and without splitting the job by `setInterval` -- are comparable in speed. There's not much difference in the overall counting time.
